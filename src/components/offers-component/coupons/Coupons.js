  ...
  return (
    <>
      <section className={styles.section}>
        ...
        <h3 className={styles.ch3}>No Coupons Available</h3>

        <svg
          className={styles.voidSvg}
          ...
          <path
            ...
            fill="#2f2e41"
          />
          <circle cx="559" cy="744.5" r="43" fill="#ff3008" />
          <circle cx="54" cy="729.5" r="43" fill="#ff3008" />
          <circle cx="54" cy="672.5" r="31" fill="#ff3008" />
          <circle cx="54" cy="624.5" r="22" fill="#ff3008" />
        </svg>
      </section>
    </>
  );
